(function(){
  ...
  .controller('BedroomOneCtrl', ['$scope', '$location', '$routeParams', 'House', function($scope, $location, $routeParams, House){
    ...
    House.getUsersHouse().then(function(response){
      ...
      $scope.bedroomOne = $scope.house.specs.bedroomOne;
    });

    $scope.updateBedroomOne = function(){
      $scope.house.specs.bedroomOne = $scope.bedroomOne;
